...
for i in range (0,240000):
    ...
    AC.IKiteration([0.7,0.3,0.3], p.getQuaternionFromEuler([1.57,0,0]), i, 500,1000)
    AC.IKiteration([0.5,0.2,0.3], p.getQuaternionFromEuler([1.57,0,0]), i, 1000,1500)
    AC.IKiteration([0.5,0.1,0.3], p.getQuaternionFromEuler([1.57,0,0]), i, 1500,2000)
    AC.IKiteration([0.5,0,0.3], p.getQuaternionFromEuler([1.57,0,0]), i, 2000,2500)
    if i == 2500:
        AC.frankaJointsLock()
