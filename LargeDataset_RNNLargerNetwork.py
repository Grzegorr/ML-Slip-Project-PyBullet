...
plt.savefig("HistoryPlots/LargeNwtworkLargeData1.png")

model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_400epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_600epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_800epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_1000epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_1200epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_1400epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_1600epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_1800epochs_Dropout30_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=200,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LargeData_LSTM_256_256_128_900examples_2000epochs_Dropout30_LastLayerLSTM.h5")
