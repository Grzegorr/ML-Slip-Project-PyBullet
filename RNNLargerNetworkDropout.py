...
model.save("TrainedNetworks/LSTM_256_256_128_900examples_400epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_800epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_1200epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_1600epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_2000epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_2400epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_2800epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_3200epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_3600epochs_Dropout_50_LastLayerLSTM.h5")

history = model.fit(x_train, y_train,epochs=400,batch_size=32,validation_data=(x_val, y_val))
model.save("TrainedNetworks/LSTM_256_256_128_900examples_4000epochs_Dropout_50_LastLayerLSTM.h5")
