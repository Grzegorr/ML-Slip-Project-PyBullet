...
plt.savefig(location +"/trainingHistory_tactileOnly.png")
plt.clf()
...
plt.xlabel('Epoch')
plt.legend(['Train-set', 'Test-set'], loc='upper left')
plt.savefig(location +"/accuracyHistory_tactileOnly.png")


###Save for F score
np.save(location + "/y_predicted_TO",model.predict(x_val))
np.save(location + "/y_GT_for_predictions_TO",y_val)
